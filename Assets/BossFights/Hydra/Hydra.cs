...
public class Hydra : MonoBehaviour {
	...
	//changed to only use negballs. removing other ball types caused a bunch of problems, and I wasn't the one who programmed this,
	//fixing them got very confusing.
